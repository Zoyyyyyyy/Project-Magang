...
async function handleGeneratePromosi() {
  ...
  console.info('[App] handleGeneratePromosi — user:', selectedUserData.nama_user, 'perintah:', perintah);

  try {
    const promoData = await generateDailyPromos(selectedUserData, perintah);
...
document.addEventListener('DOMContentLoaded', () => {
  // Bind navbar links (Adjust selectors based on your actual HTML IDs)
  ...
  // Re-verify if other initial initializations are running fine
  init();
});
